/*#include "TriangleRenderObject.h"
...
TriangleRenderObject::TriangleRenderObject(int shaderIndex) :
	RenderComp(shaderIndex)
{ }

void TriangleRenderObject::InitImpl(ID3D11Device* device)
{
	HRESULT result = S_OK;

	Vertex vertices[] =
	{
		{ XMFLOAT3(-1, -1, 0.5f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(0.0f, 1, 0.5f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(1, -1, 0.5f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
	};
...
void TriangleRenderObject::DrawFrameImpl(const RenderFrameDto& dto)
{
